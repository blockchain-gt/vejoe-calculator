...
// export async function getLP(pid) {
//   if (!totalJPS) {
...
//     10 ** pool_data.token0Decimals /
//     (pool_data.reserves[1] / 10 ** pool_data.token1Decimals);
//   console.log(
//     `${pool_data.token0Symbol}/${pool_data.token1Symbol}:    ${1 / price}`
//   );
...
//   let base_rewards =
//     (user_liquidity * totalJPS * (1 - veJOEShare)) / pool_total_liquidity;
//   let boosted_rewards =
//     ((user_liquidity * veJOE_balance) ** 0.5 * totalJPS * veJOEShare) /
//     pool_total_factor;

//   console.log(
//     `Yearly rewards: ${
//       ((base_rewards + boosted_rewards) / 10 ** 18) * SECONDS_IN_YEAR
//     }`
//   );
// }
